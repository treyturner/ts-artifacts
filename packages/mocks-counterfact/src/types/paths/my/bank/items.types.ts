...
import type { DataPage_SimpleItemSchema_ } from "../../../components/schemas/DataPage_SimpleItemSchema_.js";

export type HTTP_GET = (
  $: OmitValueWhenNever<{
    query: { item_code?: string; page?: number; size?: number };
    path: never;
    header: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: DataPage_SimpleItemSchema_;
          };
        };
      };
    }>;
  ...
  | {
      ...
      body?: DataPage_SimpleItemSchema_;
    }
