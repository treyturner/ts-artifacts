...
import type { TaskCancelledResponseSchema } from "../../../../../components/schemas/TaskCancelledResponseSchema.js";
...
export type HTTP_POST = (
  $: OmitValueWhenNever<{
    ...
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: TaskCancelledResponseSchema;
          };
        };
      };
      478: {
  ...
  | {
      ...
      body?: TaskCancelledResponseSchema;
    }
  | {
      status: 478;
    }
