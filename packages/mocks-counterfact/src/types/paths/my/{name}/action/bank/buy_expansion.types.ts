...
import type { BankExtensionTransactionResponseSchema } from "../../../../../components/schemas/BankExtensionTransactionResponseSchema.js";
...
export type HTTP_POST = (
  $: OmitValueWhenNever<{
    ...
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: BankExtensionTransactionResponseSchema;
          };
        };
      };
      486: {
  ...
  | {
      ...
      body?: BankExtensionTransactionResponseSchema;
    }
  | {
      status: 486;
    }
