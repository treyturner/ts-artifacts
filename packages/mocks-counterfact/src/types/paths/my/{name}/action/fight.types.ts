...
import type { CharacterFightResponseSchema } from "../../../../components/schemas/CharacterFightResponseSchema.js";
...
export type HTTP_POST = (
  $: OmitValueWhenNever<{
    ...
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: CharacterFightResponseSchema;
          };
        };
      };
      486: {
  ...
  | {
      ...
      body?: CharacterFightResponseSchema;
    }
  | {
      status: 486;
    }
