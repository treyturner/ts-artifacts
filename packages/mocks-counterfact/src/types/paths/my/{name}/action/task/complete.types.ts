...
import type { TasksRewardResponseSchema } from "../../../../../components/schemas/TasksRewardResponseSchema.js";
...
export type HTTP_POST = (
  $: OmitValueWhenNever<{
    ...
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: TasksRewardResponseSchema;
          };
        };
      };
      486: {
  ...
  | {
      ...
      body?: TasksRewardResponseSchema;
    }
  | {
      status: 486;
    }
