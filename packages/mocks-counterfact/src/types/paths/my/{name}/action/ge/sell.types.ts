...
import type { GETransactionItemSchema } from "../../../../../components/schemas/GETransactionItemSchema.js";
import type { GETransactionResponseSchema } from "../../../../../components/schemas/GETransactionResponseSchema.js";
...
export type HTTP_POST = (
  $: OmitValueWhenNever<{
    ...
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: GETransactionResponseSchema;
          };
        };
      };
      404: {
  ...
  | {
      ...
      body?: GETransactionResponseSchema;
    }
  | {
      status: 404;
    }
