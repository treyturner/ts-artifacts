...
import type { DepositWithdrawGoldSchema } from "../../../../../../components/schemas/DepositWithdrawGoldSchema.js";
import type { BankGoldTransactionResponseSchema } from "../../../../../../components/schemas/BankGoldTransactionResponseSchema.js";
...
export type HTTP_POST = (
  $: OmitValueWhenNever<{
    ...
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: BankGoldTransactionResponseSchema;
          };
        };
      };
      460: {
  ...
  | {
      ...
      body?: BankGoldTransactionResponseSchema;
    }
  | {
      status: 460;
    }
