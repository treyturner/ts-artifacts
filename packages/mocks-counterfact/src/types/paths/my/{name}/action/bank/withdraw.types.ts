...
import type { BankItemTransactionResponseSchema } from "../../../../../components/schemas/BankItemTransactionResponseSchema.js";
...
export type HTTP_POST = (
  $: OmitValueWhenNever<{
    ...
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: BankItemTransactionResponseSchema;
          };
        };
      };
      404: {
  ...
  | {
      ...
      body?: BankItemTransactionResponseSchema;
    }
  | {
      status: 404;
    }
