...
import type { DataPage_CharacterSchema_ } from "../components/schemas/DataPage_CharacterSchema_.js";
...
export type HTTP_GET = (
  $: OmitValueWhenNever<{
    ...
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: DataPage_CharacterSchema_;
          };
        };
      };
    }>;
  ...
  | {
      ...
      body?: DataPage_CharacterSchema_;
    }
