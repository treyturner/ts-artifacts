...
import type { DataPage_TaskFullSchema_ } from "../../components/schemas/DataPage_TaskFullSchema_.js";
...
export type HTTP_GET = (
  $: OmitValueWhenNever<{
    query: {
      min_level?: number;
      max_level?: number;
      skill?: "mining" | "woodcutting" | "fishing" | "gearcrafting" | "weaponcrafting" | "jewelrycrafting" | "cooking";
      type?: "items" | "monsters";
      page?: number;
      size?: number;
    };
    ...
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: DataPage_TaskFullSchema_;
          };
        };
      };
    }>;
