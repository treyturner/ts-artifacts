...
import type { TasksRewardFullResponseSchema } from "../../../components/schemas/TasksRewardFullResponseSchema.js";
...
export type HTTP_GET = (
  $: OmitValueWhenNever<{
    ...
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: TasksRewardFullResponseSchema;
          };
        };
      };
      404: {
  ...
  | {
      ...
      body?: TasksRewardFullResponseSchema;
    }
  | {
      status: 404;
    }
