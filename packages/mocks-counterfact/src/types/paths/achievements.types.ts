...
import type { DataPage_BaseAchievementSchema_ } from "../components/schemas/DataPage_BaseAchievementSchema_.js";
...
export type HTTP_GET = (
  $: OmitValueWhenNever<{
    ...
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: DataPage_BaseAchievementSchema_;
          };
        };
      };
    }>;
  ...
  | {
      ...
      body?: DataPage_BaseAchievementSchema_;
    }
