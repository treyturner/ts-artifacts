...
import type { DataPage_ActiveEventSchema_ } from "../components/schemas/DataPage_ActiveEventSchema_.js";
...
export type HTTP_GET = (
  $: OmitValueWhenNever<{
    ...
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: DataPage_ActiveEventSchema_;
          };
        };
      };
    }>;
  ...
  | {
      ...
      body?: DataPage_ActiveEventSchema_;
    }
