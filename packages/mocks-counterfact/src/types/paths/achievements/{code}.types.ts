...
import type { BaseachievementResponseSchema } from "../../components/schemas/BaseachievementResponseSchema.js";
...
export type HTTP_GET = (
  $: OmitValueWhenNever<{
    ...
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: BaseachievementResponseSchema;
          };
        };
      };
      404: {
  ...
  | {
      ...
      body?: BaseachievementResponseSchema;
    }
  | {
      status: 404;
    }
