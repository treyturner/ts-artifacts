...
import type { DataPage_CharacterLeaderboardSchema_ } from "../components/schemas/DataPage_CharacterLeaderboardSchema_.js";
...
export type HTTP_GET = (
  $: OmitValueWhenNever<{
    ...
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: DataPage_CharacterLeaderboardSchema_;
          };
        };
      };
    }>;
  ...
  | {
      ...
      body?: DataPage_CharacterLeaderboardSchema_;
    }
